					    ...
					    <div class="panel panel-default">
					      ...
					      <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
					        <div class="panel-body">
					         <ul id="content2">
					         	<li><label>Status :</label><span <?php echo ($mpd_status=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($mpd_status); ?></span></li>
				    ...
				    <div class="col-md-3 col-sm-3 col-xs-3">
					    <div class="panel panel-default">
						      ...
						      <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
						        <div class="panel-body">
						         <ul id="content3">
						         	<li><label>Status :</label><span <?php echo ($roon_status=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($roon_status); ?></span></li>
                                    <li><label>.</label></li>
                                    <li><label>.</label></li>
					          	</ul>
						        </div>
			    	...
			    	<div class="col-md-3 col-sm-3 col-xs-3">
					    <div class="panel panel-default">
					      ...
					      <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
					        <div class="panel-body">
					         	<ul id="content4">
					         		<li><label>Status :</label><span <?php echo ($daemon_status=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($daemon_status); ?></span></li>
                                    <li><label>.</label></li>
                                    <li><label>.</label></li>
					          	</ul>
					        </div>
						      ...
						      <div id="collapseFive" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFive">
						        <div class="panel-body">
						         <ul id="content5">
					          		...
					          		<li><label>Status :</label><span <?php echo ($wifiStatus=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($wifiStatus); ?></span></li>
			    	...
			    	<div class="col-md-3 col-sm-3 col-xs-3">
					    <div class="panel panel-default">
					      ...
					      <div id="collapseSix" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingSix">
					        <div class="panel-body">
					         	<ul id="content6">
                                    <li><label>Status :</label><span <?php echo ($shairPortStatus=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($shairPortStatus); ?></span></li>
			    	...
			    	<div class="col-md-3 col-sm-3 col-xs-3">
					    <div class="panel panel-default">
					      ...
					      <div id="collapseEight" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingEight">
					        <div class="panel-body">
					         	<ul id="content8">
                                    <li><label>Status :</label><span <?php echo ($gmrenderStatus=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($gmrenderStatus); ?></span></li>
                                    <li><label>.</label></li>
                                    <li><label>.</label></li>
					          	</ul>
					        </div>
			    	...
			    	<div class="col-md-3 col-sm-3 col-xs-3">
					    <div class="panel panel-default">
					      ...
					      <div id="collapseNine" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingNine">
					        <div class="panel-body">
					         	<ul id="content8">
                                    <li><label>Status :</label><span <?php echo ($netdataStatus=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($netdataStatus); ?></span></li>
                                    <li><label>.</label></li>
                                    <li><label>.</label></li>
					          	</ul>
					        </div>
			    	...
			    	<div class="col-md-3 col-sm-3 col-xs-3">
					    <div class="panel panel-default">
					      ...
					      <div id="collapseTen" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTen">
					        <div class="panel-body">
					         	<ul id="content8">
                                    <li><label>Status :</label><span <?php echo ($squeezeliteStatus=='Active')?'class="green-text"':'class="red-text"'?>><?php echo strtoupper($squeezeliteStatus); ?></span></li>
                                    <li><label>.</label></li>
				      ...
				      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
				        <div class="panel-body">
				          	<ul id="content">
				          		...
				          		<li><label>Hostname :</label><span><a href="{{url('/user/system_settings')}}"><?php echo strtoupper($hostName); ?></a></span></li>
				          		<li><label>Soundcard :</label><span><a href="{{url('/user/system_settings')}}"><?php echo strtoupper($soundCard); ?></a></span></li>
				          	</ul>
				        </div>
				        <div class="edit-option">
