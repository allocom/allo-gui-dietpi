												...
												<div class="col-md-6 col-sm-4 col-xs-12 right-input">
													<div class="switch">
														<label class="switch-light" onclick="">
															<input type="hidden" name = "mpdStatus" value = "no">
															<input type="checkbox" id = "chk" name = "mpdStatus" value = "yes">
																<span>
																	<span>Active</span>
																	<span>Inactive</span>
																</span>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if((mpd_status)=='Inactive' || (mpd_status) == 0) {
	...
	//var mpdValue = $('.SOXR_STATUS').val();

		$('#sve-chngs').on('click',function() {
			if(!($('#soxr_status').prop("checked")) || !($('#bitDepth').prop("checked")) || !($('#frequency').prop("checked"))) {
